  ...
  const handleAddItem = async () => {
    ...
    try {
      const res = await axios.post(
        `http://localhost:8080/admin/edit/product/${info.id}`,
        info,
        {
  ...
  return (
    <Wrapper>
      ...
      <PrevButton onClick={()=> navigate(-1)}>
        ...
        <Form>
        <FormGroup>
            <Label htmlFor="productName" style={{ paddingTop: 20 }}>상품 아이디</Label>
            <Input
              id="productName"
              name="productName"
          ...
          <FormGroup>
            ...
            <Select onChange={(e) => setInfo({ ...info, categoryId: e.target.value })}>
