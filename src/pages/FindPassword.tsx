  ...
  return (
    <Wrapper>
      ...
      <Container>
        ...
        <Form>
          <InputRow>
            <Input type="text" placeholder="ID" onChange={(e) => setInfo({ ...info, id: e.target.value})}/>

          </InputRow>
          <InputRow>
            <FullWidthInput type="name" placeholder="Name" onChange={(e) => setInfo({ ...info, name: e.target.value})}/>
            <FullWidthInput type="text" placeholder="Phone Number" onChange={(e) => setInfo({ ...info, phone: e.target.value})}/>
          </InputRow>
